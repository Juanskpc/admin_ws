...
| **F8** | WhatsApp como canal (mismo `ChannelPort`; captura de body crudo para firma de Meta). **→ MVP COMERCIAL.** | 016, 017 | **Partida en tres (2026-08-19)**: **F8-A** el canal —firma, webhook, traducción, opt-out— **hecha en local**; **F8-B** —ventana de 24 h, plantillas, recordatorios proactivos, backoff y acuses— **hecha en local (2026-08-20)**, con `cita.creada.v1` como primer evento de dominio vivo; **F8-C** conectar el número, **bloqueada por el trámite con Meta**. Fuera de F8-B, y decidido: **multimedia/visión**, que no se puede verificar sin descargar medios de Meta. El corte se puso donde acaba lo que se puede verificar sin cuenta. Detalle en `docs/canal-whatsapp.md` |
